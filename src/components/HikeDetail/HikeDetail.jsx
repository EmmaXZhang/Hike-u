    ...
    <div className="detail-container">
      ...
      <div className="list-container list-container-detail ">
        {detail.spots && (
          <div>
            {" "}
            <div className="list-title list-title-detail ">
              Your Spots:
            </div>{" "}
            <ul className="list-group list-group-flush list-group-detail ">
              {detail.spots.map((spot, index) => (
      ...
      <div className="btn-container">
        <Link to="/journals/new">
          <button className="create-btn">Create Journal</button>
        </Link>
      </div>
      <div className="btn-container">
        <Link to="/">
          <button onClick={_deleteHike} className="create-btn delete-btn">
            Delete Plan
          </button>
        </Link>
      </div>
